        ...
        <div style={box.outer}>
          ...
          <div style={box.grid}>
            <Card title="제출 서류 반려/승인" body1="신청한 장학금"
                  body2="서류들을 한 눈에." linkTo="/submissions"/>
            <Card title="장학금 관리" body1="진행 중인 장학금"
                  body2="목록을 한 눈에." linkTo="/scholarships"/>
            <Card title="공지사항 관리" body1="장학금 관련"
                  body2="공지사항을 한 눈에." linkTo="/notices"/>
            <Card title="마일리지 환전 관리" body1="사용자 환전 신청"
                  body2="승인/거절 관리" linkTo="/exchange"/>
          </div>
